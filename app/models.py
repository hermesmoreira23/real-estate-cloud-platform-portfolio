...
class Property(Base):               
    ...
    id = Column(Integer, primary_key=True, index=True)      # Clave primaria autoincremental y con índice para búsquedas eficientes
    name = Column(String, index=True)                       # Nombre de la propiedad, útil para buscar por palabra
    location = Column(String)                               # Campo de texto para indicar ubicación (ciudad, barrio, etc.)
